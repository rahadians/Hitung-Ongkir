...
class ProvinsiAwal extends GetView<HomeController> {
  const ProvinsiAwal({
    Key? key,
  }) : super(key: key);
    ...
    return DropdownSearch<Province>(
      ...
      onChanged: (value) {
        if (value == null) {
          ...
          controller.provAwalid.value = "Belum Mimilih Provinsi";
        } else {
          controller.provAwalid.value = value.provinceId;
          // print(controller.provAwalid.value);
        }
      },
    );
  }
